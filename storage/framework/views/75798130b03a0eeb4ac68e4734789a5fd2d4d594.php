        ...
        <div class="card bg-light m-2 p-3 shadow">
            ...
            <div class="tab-content" id="ownerTabsContent">
                ...
                <div class="tab-pane fade show active" id="owner" role="tabpanel" aria-labelledby="owner-tab">
                    <div class="p-3">
                        <form action="<?php echo e(route('admin.owners.update', $owner->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <?php echo $__env->make('admin.owners.forms.owner_form', ['owner' => $owner], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </form>
                        <form action="<?php echo e(url('admin.owners.delete_file', $file->id ?? '')); ?>" method="POST" class="delete-file-form mt-3">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projecttracker/resources/views/admin/owners/edit.blade.php ENDPATH**/ ?>