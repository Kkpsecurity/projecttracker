    ...
    <div class="col-lg-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                ...
                <form action="<?php echo e(route('admin.hb837.backup.toggle_cron')); ?>" method="POST"
                    ...
                    <div class="form-check form-switch mb-0">
                        ...
                        <input type="checkbox" class="form-check-input" name="enabled" value="1"
                            ...
                            <?php echo e(cache('backup_cron_enabled', true) ? 'checked' : ''); ?>>
                        <label class="form-check-label ms-2 text-muted small" for="cronToggle">Auto Backup</label>
                    </div>
                </form>
            </div>
            <div class="card-body">
                <?php if(cache('backup_cron_enabled', true)): ?>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <div class="text-muted small">
                                    Runs daily at <code><?php echo e(config('backup.cron_time_at')); ?></code>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="d-flex justify-content-between">
                                    <strong><?php echo e($event->user->name ?? 'System'); ?></strong>
                                ...
                                <div class="text-muted small">
                                    Created backup via <?php echo e(ucfirst($event->changes['trigger'] ?? 'unknown method')); ?>
...
<?php /**PATH /var/www/projecttracker/resources/views/admin/services/backup/action_cards.blade.php ENDPATH**/ ?>