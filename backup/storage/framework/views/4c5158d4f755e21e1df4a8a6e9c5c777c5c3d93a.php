    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-between align-items-center p-3">
                <h2 class="text-dark">Consultant Details - <?php echo e($consultant->first_name); ?> <?php echo e($consultant->last_name); ?></h2>
                <div>
        ...
        <div class="tab-content p-4 bg-white shadow rounded border">
            <div class="tab-pane fade" id="consultantDetails">
                <?php echo $__env->make('admin.consultants.forms.form', ['consultant' => $consultant], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="tab-pane fade" id="currentAssignments">
                <?php echo $__env->make('admin.consultants.tables.orders', ['assignOrders' => $assignments ?? collect()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="tab-pane fade" id="completedProjects">
                <?php echo $__env->make('admin.consultants.tables.completed', ['completedOrders' => $completedProjects ?? collect()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projecttracker/resources/views/admin/consultants/edit.blade.php ENDPATH**/ ?>