                        ...
                        <div class="tab-content" id="editTabsContent">
                            ...
                            <div class="tab-pane fade {{ $tab === 'general' ? 'show active' : '' }}" id="general" role="tabpanel" aria-labelledby="general-tab">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <h5 class="text-primary"><i class="fas fa-building"></i> Property Details</h5>
                                        <hr>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('property_type') is-invalid @enderror" id="property_type" name="property_type">
                                                        ...
                                                        <option value="midrise" {{ old('property_type', $hb837->property_type) == 'midrise' ? 'selected' : '' }}>Mid-Rise</option>
                                                        <option value="highrise" {{ old('property_type', $hb837->property_type) == 'highrise' ? 'selected' : '' }}>High-Rise</option>
                                                        <option value="industrial" {{ old('property_type', $hb837->property_type) == 'industrial' ? 'selected' : '' }}>Industrial</option>
                                                        <option value="bungalo" {{ old('property_type', $hb837->property_type) == 'bungalo' ? 'selected' : '' }}>Bungalo</option>
                                                    </select>
                                                    @error('property_type')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('securitygauge_crime_risk') is-invalid @enderror" id="securitygauge_crime_risk" name="securitygauge_crime_risk">
                                        ...
                                        <h5 class="text-primary mt-4"><i class="fas fa-handshake"></i> Macro Client</h5>
                                        <hr>
                                    ...
                                    <div class="col-md-6">
                                        <!-- Status & Progress -->
                                        <h5 class="text-primary"><i class="fas fa-tasks"></i> Status & Progress</h5>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('report_status') is-invalid @enderror" id="report_status" name="report_status">
                                                        ...
                                                        <option value="underway" {{ old('report_status', $hb837->report_status) == 'underway' ? 'selected' : '' }}>In Progress</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('contracting_status') is-invalid @enderror" id="contracting_status" name="contracting_status">
                                                        <option value="">Select Status</option>
                                        ...
                                        <!-- Important Dates -->
                                        <h5 class="text-primary mt-4"><i class="fas fa-calendar-alt"></i> Important Dates</h5>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            <label for="report_submitted">Report Submitted Date</label>
                                        ...
                                        <!-- General Notes -->
                                        <h5 class="text-primary mt-4"><i class="fas fa-sticky-note"></i> Notes</h5>
                                        <hr>
                            ...
                            <div class="tab-pane fade {{ $tab === 'contact' ? 'show active' : '' }}" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-12">
                                        <h5 class="text-primary"><i class="fas fa-user-tie"></i> Owner Information</h5>
                                        <hr>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('owner_name') is-invalid @enderror"
                                                   id="owner_name" name="owner_name" value="{{ old('owner_name', $hb837->owner_name) }}">
                                            @error('owner_name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <h5 class="text-primary"><i class="fas fa-user-cog"></i> Property Manager</h5>
                                        <hr>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade {{ $tab === 'financial' ? 'show active' : '' }}" id="financial" role="tabpanel" aria-labelledby="financial-tab">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="billing_req_submitted">Billing Request Submitted</label>
                                            <input type="date" class="form-control @error('billing_req_submitted') is-invalid @enderror"
                                                   id="billing_req_submitted" name="billing_req_submitted"
                                                   value="{{ old('billing_req_submitted', $hb837->billing_req_submitted ? (is_object($hb837->billing_req_submitted) ? $hb837->billing_req_submitted->format('Y-m-d') : $hb837->billing_req_submitted) : '') }}">
                                            @error('billing_req_submitted')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control @error('project_net_profit') is-invalid @enderror"
                                                       id="project_net_profit" name="project_net_profit" value="{{ old('project_net_profit', (string)$hb837->project_net_profit) }}" readonly>
                                            ...
                                            <small class="form-text text-muted">
                                                ...
                                                Automatically calculated: Quoted Price - Sub Fees & Expenses
                                            </small>
                                        </div>
                            ...
                            <div class="tab-pane fade {{ $tab === 'notes' ? 'show active' : '' }}" id="notes" role="tabpanel" aria-labelledby="notes-tab">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="consultant_notes_tab">Consultant Notes</label>
                                            <textarea class="form-control @error('consultant_notes') is-invalid @enderror" id="consultant_notes_tab" name="consultant_notes" rows="4">{{ old('consultant_notes', $hb837->consultant_notes) }}</textarea>
