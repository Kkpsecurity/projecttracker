    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('securitygauge_crime_risk') is-invalid @enderror" 
                ...
                <option value="Low" {{ old('securitygauge_crime_risk', $hb837->securitygauge_crime_risk ?? '') == 'Low' ? 'selected' : '' }}>Low</option>
                <option value="Moderate" {{ old('securitygauge_crime_risk', $hb837->securitygauge_crime_risk ?? '') == 'Moderate' ? 'selected' : '' }}>Moderate</option>
                <option value="Elevated" {{ old('securitygauge_crime_risk', $hb837->securitygauge_crime_risk ?? '') == 'Elevated' ? 'selected' : '' }}>Elevated</option>
                <option value="High" {{ old('securitygauge_crime_risk', $hb837->securitygauge_crime_risk ?? '') == 'High' ? 'selected' : '' }}>High</option>
                <option value="Severe" {{ old('securitygauge_crime_risk', $hb837->securitygauge_crime_risk ?? '') == 'Severe' ? 'selected' : '' }}>Severe</option>
            </select>
