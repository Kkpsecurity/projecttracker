...
@section('content')
    <div class="container" style="height: auto;">
        <div class="row justify-content-center">
            <div class="col-md-12 d-flex justify-content-between align-items-center">
                <h2>Projects</h2>
                <span><a href="#" data-toggle="modal" data-target="#create_project" class="btn btn-success"><i
                            class="fa fa-plus"></i> Create a New Project</a></span>
            </div>
                        ...
                        @if (count($clients) > 0)
                            @foreach ($clients as $client)
                                <tr>
                                    ...
                                    <td><a
                                            href="{{ url('home/detail', $client->id) }}"><strong>{{ $client->project_name }}</strong></a>
                                    </td>
    ...
    <!-- Modal -->
    <div class="modal fade" id="create_project" tabindex="-1" role="dialog" aria-labelledby="CreateProjectModal"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('home.process') }}" id="project-form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="client_name" name="client_name" class="form-control" id="client_name"
                                placeholder="Enter a Client Name">
                        </div>

                        <div class="form-group">
                            <label for="project_name">Project Name</label>
                            <input type="project_name" name="project_name" class="form-control" id="project_name"
            ...
            CreateTrigger.on('click', function() {
                ...
                $.ajax({
                    ...
                    always: function(result) {
                        alert(
                            'Some thing went wrong, But we are not sure what. This error has been logged');
                    }
                });
