    ...
    <div class="container-fluid px-4 py-4">
        ...
        <div class="tab-content bg-white p-5" id="backupTabsContent">
            <div class="tab-pane fade show active" id="hb837" role="tabpanel" aria-labelledby="hb837-tab">
                @include('admin.services.backup.stats_cards', [
                    'backups' => $backups,
                    'stats' => $stats,
                    'systemStats' => $systemStats,
                    'recentActivity' => $recentActivity,
                ])
                @include('admin.services.backup.action_cards')
                @include('admin.services.backup.backup_history', ['backups' => $backups])
            </div>
            <div class="tab-pane fade" id="system" role="tabpanel" aria-labelledby="system-tab">
                @include('admin.services.backup.dashboard')
            </div>
            <div class="tab-pane fade" id="imports" role="tabpanel" aria-labelledby="imports-tab">
                @include('admin.services.backup.imports')
            </div>
        </div>
    </div>
