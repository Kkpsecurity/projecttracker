...
<div class="row mb-4">
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                @if(!empty($systemStats['monthly_trends']))
                    <!-- Activity Chart -->
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-sm">
                                    ...
                                    <tbody>
                                        @foreach($systemStats['monthly_trends'] as $trend)
                                            @php
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class="badge bg-primary">{{ $trend['backups_created'] }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-info">{{ $trend['imports_performed'] }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-secondary">{{ $trend['data_volume'] }}</span>
                                                </td>
                                                <td class="text-center">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (canvas) {
        ...
        const data = @json($systemStats['monthly_trends'] ?? []);
