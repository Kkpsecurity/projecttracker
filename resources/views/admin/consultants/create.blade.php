...
@section('title', 'Add Consultant - ProjectTracker Fresh')
                ...
                <div class="card-body">
                    <form action="{{ route('admin.consultants.store') }}" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('dba_company_name') is-invalid @enderror"
                                           id="dba_company_name" name="dba_company_name" value="{{ old('dba_company_name') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('fcp_expiration_date') is-invalid @enderror"
                                           id="fcp_expiration_date" name="fcp_expiration_date" value="{{ old('fcp_expiration_date') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('assigned_light_meter') is-invalid @enderror"
                                           id="assigned_light_meter" name="assigned_light_meter" value="{{ old('assigned_light_meter') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('lm_nist_expiration_date') is-invalid @enderror"
                                           id="lm_nist_expiration_date" name="lm_nist_expiration_date" value="{{ old('lm_nist_expiration_date') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control @error('subcontractor_bonus_rate') is-invalid @enderror"
                                               ...
                                               value="{{ old('subcontractor_bonus_rate') }}" min="0">
                        ...
                        <div class="form-group text-right">
                            ...
                            <a href="{{ route('admin.consultants.index') }}" class="btn btn-secondary btn-lg ml-2">
